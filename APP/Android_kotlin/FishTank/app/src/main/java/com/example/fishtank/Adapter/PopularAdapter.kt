...
import com.example.fishtank.DetalActivity
import com.example.fishtank.Model.ItemsModel
import com.example.fishtank.databinding.ViewholderRecommendedBinding
...
class PopularAdapter (val items:MutableList<ItemsModel>):RecyclerView.Adapter<PopularAdapter.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: PopularAdapter.ViewHolder, position: Int) {
        ...
        val requsOptions = RequestOptions().transform(CenterCrop())
