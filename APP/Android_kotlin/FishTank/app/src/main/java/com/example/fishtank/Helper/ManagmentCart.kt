...
class ManagmentCart(val context: Context) {
    ...
    fun insertFood(item: ItemsModel) {
        ...
        Toast.makeText(context, "已新增到購物車", Toast.LENGTH_SHORT).show()
    }
    ...
    fun cleanItem(listFood: ArrayList<ItemsModel>, position: Int, listener: ChangeNumberItemsListener){
        listFood[position].numberInCart=0
        tinyDB.putListObject("CartList", listFood)
        listener.onChanged()
    }
